...
<body>
    ...
    <main>   
        <section>
            ...
            * @since: 27/11/2025
            * 2. Desarrollo de un control de acceso con identificación del usuario basado en la función header() y en el uso de una tabla “Usuario” de la base de datos. (PDO).
            */
            ...
            $usuarioPasswd=$_SERVER['PHP_AUTH_USER'].$_SERVER['PHP_AUTH_PW'];
              ...
              if(!isset($_SERVER['PHP_AUTH_USER'])) {
               ...
               try {
                   ...
                   $sql = "SELECT T01_CodUsuario, T01_Password, T01_DescUsuario FROM T01_Usuarios
